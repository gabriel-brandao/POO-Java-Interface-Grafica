...
public class JanelaCadastroClientes extends javax.swing.JFrame {
    ...
    private void removerCliente(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removerCliente
        // TODO add your handling code here:
        Visão <String> visaoSelecionada = (Visão <String>) clientesCadastradosComboBox.getSelectedItem();// converte o objeto do comboBox para objeto Visao <String>
        String mensagem_erro;

        if(visaoSelecionada != null)
            mensagem_erro = controlador.removerCliente(visaoSelecionada.getChave());
         else
            mensagem_erro = "Nenhum Cliente Selecionado";

        if(mensagem_erro == null){
            visaoClientesCadastrados.remove(visaoSelecionada);
