...
public class Imóvel {
    ...
    public static Imóvel buscarImovel2(Integer sequencial) {
         String sql = "SELECT * FROM Imóvel I, Endereço E, Comodo C " + "WHERE I.EndereçoId = E.SequencialEnd AND I.ComodosId = C.SequencialCom AND E.Cep = ? AND E.Complemento = ?SELECT * FROM Imóvel I, Comodo C, Endereço E WHERE I.SequencialImo = ? AND I.ComodosId = C.SequencialCom AND I.EndereçoId = E.SequencialEnd";
    ...
    public static String removerImovel(Integer chave) {
        String sql = "DELETE Imóvel, Comodo, Endereço " + "WHERE ";
